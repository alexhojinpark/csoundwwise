...
#ifndef csoundwwiseFXParams_H
#define csoundwwiseFXParams_H
...
struct csoundwwiseNonRTPCParams
{
};

struct csoundwwiseFXParams
    : public AK::IAkPluginParam
{
    csoundwwiseFXParams();
    csoundwwiseFXParams(const csoundwwiseFXParams& in_rParams);
