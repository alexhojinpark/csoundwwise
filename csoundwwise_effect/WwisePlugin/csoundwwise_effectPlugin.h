...
class csoundwwise_effectPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    csoundwwise_effectPlugin();
    ~csoundwwise_effectPlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(csoundwwise_effect);	// Exposes our PluginContainer structure that contains the info for our plugin
