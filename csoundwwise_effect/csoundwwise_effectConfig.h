...
#ifndef csoundwwise_effectConfig_H
#define csoundwwise_effectConfig_H
...
namespace csoundwwise_effectConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 8972;
}

#endif // csoundwwise_effectConfig_H
