...
#ifndef csoundwwise_effectFX_H
#define csoundwwise_effectFX_H
...
class csoundwwise_effectFX
    : public AK::IAkInPlaceEffectPlugin
{
public:
    csoundwwise_effectFX();
    ~csoundwwise_effectFX();
...
private:
    csoundwwise_effectFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;
};

#endif // csoundwwise_effectFX_H
