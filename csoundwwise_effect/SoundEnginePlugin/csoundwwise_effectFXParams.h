...
#ifndef csoundwwise_effectFXParams_H
#define csoundwwise_effectFXParams_H
...
struct csoundwwise_effectRTPCParams
{
    AkReal32 fPlaceholder;
};

struct csoundwwise_effectNonRTPCParams
{
};

struct csoundwwise_effectFXParams
    : public AK::IAkPluginParam
{
    csoundwwise_effectFXParams();
    csoundwwise_effectFXParams(const csoundwwise_effectFXParams& in_rParams);
    ...
    csoundwwise_effectRTPCParams RTPC;
    csoundwwise_effectNonRTPCParams NonRTPC;
};

#endif // csoundwwise_effectFXParams_H
