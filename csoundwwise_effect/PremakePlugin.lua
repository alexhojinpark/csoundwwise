...
local Plugin = {}
Plugin.name = "csoundwwise_effect"
Plugin.factoryheader = "../SoundEnginePlugin/csoundwwise_effectFXFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "csoundwwise_effectFXShared.cpp"
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "csoundwwise_effect.def",
    "csoundwwise_effect.xml",
    "**.rc",
}
