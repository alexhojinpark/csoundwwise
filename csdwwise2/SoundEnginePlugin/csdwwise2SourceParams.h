...
#ifndef csdwwise2SourceParams_H
#define csdwwise2SourceParams_H
...
struct csdwwise2RTPCParams
{
    AkReal32 fDuration;
};

struct csdwwise2NonRTPCParams
{
};

struct csdwwise2SourceParams
    : public AK::IAkPluginParam
{
    csdwwise2SourceParams();
    csdwwise2SourceParams(const csdwwise2SourceParams& in_rParams);
    ...
    csdwwise2RTPCParams RTPC;
    csdwwise2NonRTPCParams NonRTPC;
};

#endif // csdwwise2SourceParams_H
