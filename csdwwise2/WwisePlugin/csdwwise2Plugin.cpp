...
#include "csdwwise2Plugin.h"
#include "../SoundEnginePlugin/csdwwise2SourceFactory.h"

csdwwise2Plugin::csdwwise2Plugin()
{
}
...
AK_EXPORT_PLUGIN_CONTAINER(csdwwise2);											// This is a DLL, we want to have a standardized name
AK_ADD_PLUGIN_CLASS_TO_CONTAINER(                                             // Add our CLI class to the PluginContainer
    csdwwise2,        // Name of the plug-in container for this shared library
    csdwwise2Plugin,  // Authoring plug-in class to add to the plug-in container
    csdwwise2Source   // Corresponding Sound Engine plug-in class
);
