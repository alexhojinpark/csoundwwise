...
#ifndef csdwwiseFXParams_H
#define csdwwiseFXParams_H
...
struct csdwwiseRTPCParams
{
    AkReal32 fPlaceholder;
};

struct csdwwiseNonRTPCParams
{
};

struct csdwwiseFXParams
    : public AK::IAkPluginParam
{
    csdwwiseFXParams();
    csdwwiseFXParams(const csdwwiseFXParams& in_rParams);
    ...
    csdwwiseRTPCParams RTPC;
    csdwwiseNonRTPCParams NonRTPC;
};

#endif // csdwwiseFXParams_H
