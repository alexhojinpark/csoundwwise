...
class csoundwwise_sourcePlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    csoundwwise_sourcePlugin();
    ~csoundwwise_sourcePlugin();
...
AK_DECLARE_PLUGIN_CONTAINER(csoundwwise_source);	// Exposes our PluginContainer structure that contains the info for our plugin
