...
#ifndef csoundwwise_sourceConfig_H
#define csoundwwise_sourceConfig_H
...
namespace csoundwwise_sourceConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 25950;
}

#endif // csoundwwise_sourceConfig_H
