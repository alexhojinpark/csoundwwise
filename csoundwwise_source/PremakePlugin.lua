...
local Plugin = {}
Plugin.name = "csoundwwise_source"
Plugin.factoryheader = "../SoundEnginePlugin/csoundwwise_sourceSourceFactory.h"
Plugin.appleteamid = ""
Plugin.signtoolargs = {}
Plugin.sdk = {}
Plugin.sdk.static = {}
...
{
    "csoundwwise_sourceSourceShared.cpp"
}
...
{
    "csoundwwise_sourceSourceShared.cpp",
    "csoundwwise_sourceSourceFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "csoundwwise_source.def",
    "csoundwwise_source.xml",
    "**.rc",
}
