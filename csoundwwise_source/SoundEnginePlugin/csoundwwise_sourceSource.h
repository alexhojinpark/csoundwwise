...
#ifndef csoundwwise_sourceSource_H
#define csoundwwise_sourceSource_H
...
class csoundwwise_sourceSource
    : public AK::IAkSourcePlugin
{
public:
    csoundwwise_sourceSource();
    ~csoundwwise_sourceSource();
