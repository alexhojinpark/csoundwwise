...
#ifndef csoundwwise_sourceSourceParams_H
#define csoundwwise_sourceSourceParams_H
...
struct csoundwwise_sourceRTPCParams
{
    AkReal32 fDuration;
};

struct csoundwwise_sourceNonRTPCParams
{
};

struct csoundwwise_sourceSourceParams
    : public AK::IAkPluginParam
{
    csoundwwise_sourceSourceParams();
    csoundwwise_sourceSourceParams(const csoundwwise_sourceSourceParams& in_rParams);
    ...
    csoundwwise_sourceRTPCParams RTPC;
    csoundwwise_sourceNonRTPCParams NonRTPC;
};

#endif // csoundwwise_sourceSourceParams_H
